...
class AddNewTaskForm {
    ...
    changeContent(newContent){
        ...
        this.setState({ validationError, content: newContent, submittable})
    }

    clearForm() {
        this.setState({ validationError: '', content: '', submittable: false})
    }
...
export default AltInstance.createStore(AddNewTaskForm)